...
var ImageDitherPlugin = class extends import_obsidian.Plugin {
  ...
  async setDefaultPresetName(name) {
    const valid = name === AUTO_PRESET_OPTION || PRESETS.some((preset) => preset.name === name) ? name : DEFAULT_SETTINGS.defaultPresetName;
...
${width} x ${height} px`
  ...
  getActivePresetName() {
    ...
    return (_a = match == null ? void 0 : match.name) != null ? _a : DEFAULT_SETTINGS.defaultPresetName;
  }
